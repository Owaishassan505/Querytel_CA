...
<body class="bg-white text-neutral-900 font-sans">
    ...
    <section class="relative overflow-hidden bg-white">
        <svg class="pointer-events-none absolute -top-10 -right-10 w-[520px] h-[520px] text-slate-100"
            ...
            <defs>
                <linearGradient id="acc-adv-accent" x1="0" y1="0" x2="1" y2="1">
                    <stop offset="0%" stop-color="currentColor" stop-opacity=".6" />
                    <stop offset="100%" stop-color="currentColor" stop-opacity="0" />
                </linearGradient>
            </defs>
            <circle cx="300" cy="300" r="300" fill="url(#acc-adv-accent)" />
        </svg>
        ...
        <div class="max-w-7xl mx-auto px-6 py-28 md:py-32">
            <div class="max-w-3xl opacity-0 animate-fadeInUp">
                ...
                <p class="mt-5 text-lg md:text-xl text-neutral-600">
                    Backup + Cyber Protection plans for always-on data safety and simplified management.
                </p>
    ...
    <section class="bg-slate-900">
        <div class="max-w-7xl mx-auto px-6 py-8 text-center">
            <h2 class="text-white text-2xl md:text-3xl font-extrabold tracking-wide">
                ACRONIS CYBER CLOUD ADVANCED
            </h2>
            <p class="mt-3 text-slate-300 text-sm md:text-base">
                Only Backup &amp; Cyber Protection
            </p>
        </div>
    </section>
    ...
    <section id="plans" class="bg-white py-16">
        <div class="max-w-7xl mx-auto px-6 grid md:grid-cols-3 gap-8">
            <?php
            $plans = [
                ["title" => "Cloud Protect 50", "storage" => "50GB Cloud Storage"],
                ["title" => "Cloud Protect 100", "storage" => "100GB Cloud Storage"],
                ["title" => "Cloud Protect 200", "storage" => "200GB Cloud Storage"],
            ];
            // NOTE: No Disaster Recovery item here (per “Advanced” screenshot)
            $features = [
