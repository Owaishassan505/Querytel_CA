        ...
        <div class="relative max-w-7xl mx-auto px-6 py-20 grid md:grid-cols-2 gap-12 items-center">
            <div>
                ...
                <p class="mt-4 text-orange-50 text-lg">
                    ...
                    integration.
                    Brand it your way and manage everything centrally.
                </p>
        ...
        <div class="max-w-7xl mx-auto px-6">
            ...
            <div class="max-w-5xl">
                ...
                <p class="mt-6 text-neutral-700 leading-relaxed">
                    ...
                    service providers
                    to use one solution to deliver backup, disaster recovery, file sync and share, notarization and
                    eSignature
                    services to clients. With smooth and quick onboarding, service providers can leverage Acronis Cyber
                    Notary Cloud
                    to enrich their solution portfolio and increase ARPUs.
                </p>
            </div>
                        ...
                        <div class="p-8">
                            ...
                            <ul class="mt-6 space-y-4 text-sm leading-relaxed">
                                ...
                                <li class="flex gap-3">
                                    ...
                                    integrates with native Microsoft Office
                        ...
                        <div class="p-8">
                            ...
                            <ul class="mt-6 space-y-4 text-sm leading-relaxed">
                                <li class="flex gap-3">
                                    ...
                                    secure content management features include automatic file storage, sync, share and
                                ...
                                <li class="flex gap-3">
                                    ...
                                    Ease client compliance concerns – with a HIPAA/HITECH security program already built
                                    in, Acronis Cyber Files Cloud
                                    upholds the strictest security and privacy standards; it provides an
                                    enterprise-class audit trail and a full
        ...
        <div class="max-w-7xl mx-auto px-6">
            ...
            <header class="text-center">
                <h2 class="text-3xl md:text-4xl font-bold tracking-tight text-white">
                    Five benefits of Acronis Cyber Files Cloud
                </h2>
            ...
            <div class="mt-10 grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <article
                    ...
                    <p class="px-5 pb-6 pt-4 text-sm leading-6 text-slate-300">
                        Protect mobile and desktop devices, including BYOD, with a secure, policy-driven collaboration
                        platform.
                    </p>
                </article>
                ...
                <article
                    ...
                    <p class="px-5 pb-6 pt-4 text-sm leading-6 text-slate-300">
                        Store and share content on secure cloud infrastructure designed for reliability.
                    </p>
                </article>
            </div>
        </div>
