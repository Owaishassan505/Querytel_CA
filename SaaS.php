...
<body class="bg-white text-neutral-900 font-sans">
  ...
  <!-- STICKY CTA BAR -->
  <div id="stickyCta" class="fixed inset-x-0 bottom-4 z-40 px-4 sm:px-6 lg:px-8"
    aria-label="Quick contact for SaaS help">
    <div
      class="mx-auto max-w-5xl rounded-2xl bg-neutral-900/90 text-white shadow-2xl ring-1 ring-white/10 backdrop-blur">
      <div class="flex flex-col gap-3 p-4 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div class="flex items-center justify-center gap-3">
          <a href="<?= $base ?? '' ?>/contactus"
            class="inline-flex items-center gap-2 rounded-lg bg-orange-600 px-5 py-2.5 font-semibold text-white hover:bg-orange-700 transition">
            Request an Expert
          ...
          <button onclick="document.getElementById('stickyCta').remove()"
            class="rounded-lg px-3 py-2 text-sm text-white/70 hover:text-white transition" aria-label="Dismiss">
            Dismiss
          </button>
        </div>
      </div>
  ...
  <section class="relative overflow-hidden bg-gradient-to-br from-slate-50 via-white to-slate-100">
    <div aria-hidden="true" class="absolute inset-0">
      ...
      <svg class="absolute inset-0 w-full h-full text-slate-200/50" aria-hidden="true">
        <defs>
          <pattern id="hero-grid-tight" width="8" height="8" patternUnits="userSpaceOnUse">
    ...
    <div class="relative max-w-7xl mx-auto px-6 py-20 sm:py-24 lg:py-32">
      <div class="mx-auto max-w-3xl mb-4 text-center">
        <div
          class="inline-flex items-center gap-2 rounded-full bg-white/80 ring-1 ring-slate-200 px-3 py-1.5 text-[12px] text-slate-700 backdrop-blur">
      ...
      <div class="mx-auto max-w-3xl text-center">
        ...
        <p class="mt-4 sm:mt-5 text-base sm:text-lg md:text-xl text-neutral-600">
          We plan, deploy, and operate your cloud apps—Microsoft 365, Zoho, Acronis, Teams Voice—with SSO/MFA, device
          controls, and daily backups. Clear process, predictable results.
        </p>
        <div class="mt-7 flex flex-col sm:flex-row items-center justify-center gap-4">
          <a href="<?= $base ?? '' ?>/contactus"
            class="inline-flex items-center gap-2 bg-orange-600 text-white px-7 py-3 rounded-xl hover:bg-orange-700 transition font-semibold shadow-md">
            Request an Expert
            <svg class="h-4 w-4" viewBox="0 0 24 24" aria-hidden="true" fill="currentColor">
              <path d="M13 5l7 7-7 7-1.5-1.5L16 13H4v-2h12l-4.5-4.5L13 5z" />
            </svg>
          ...
          <a href="#plans"
            class="inline-flex items-center gap-2 border border-blue-700 text-blue-700 px-7 py-3 rounded-xl hover:bg-blue-50 transition font-semibold">
            View Bundles
          </a>
        </div>
      </div>
      ...
      <div class="mt-12 sm:mt-14 mx-auto max-w-5xl">
        <div
          class="rounded-[28px] bg-white ring-1 ring-slate-200 shadow-[0_24px_80px_rgba(2,6,23,.12)] overflow-hidden">
          <div
            class="px-5 py-3 bg-gradient-to-r from-blue-50 to-blue-100 border-b border-blue-200 flex items-center gap-2">
          ...
          <div class="p-6 sm:p-8">
            <div class="grid gap-4 sm:grid-cols-3">
              <div class="rounded-xl border border-slate-200 p-4" aria-label="Identity and access">
                ...
                <p class="mt-2 text-sm text-slate-600">Log in once, stay secure everywhere—no sticky notes, no lockouts.
                </p>
              </div>
              <div class="rounded-xl border border-slate-200 p-4" aria-label="Backups">
                ...
                <p class="mt-2 text-sm text-slate-600">Automatic copies of the important stuff, with point-in-time
                  restore.</p>
              </div>
              <div class="rounded-xl border border-slate-200 p-4" aria-label="Observability">
                ...
                <p class="mt-2 text-sm text-slate-600">You’ll know what changed, who has access, and what needs
                  attention.</p>
              </div>
            </div>
          </div>
        ...
        <div
          class="mt-6 rounded-xl border border-neutral-200/60 bg-white/70 p-3 backdrop-blur text-sm text-neutral-700 flex flex-wrap items-center justify-center gap-x-6 gap-y-2">
          <span class="flex items-center gap-2"><span class="h-1.5 w-1.5 rounded-full bg-orange-600"></span> Microsoft
            365 • Teams • SharePoint</span>
          <span class="flex items-center gap-2"><span class="h-1.5 w-1.5 rounded-full bg-orange-600"></span> Zoho
            CRM/Books</span>
          <span class="flex items-center gap-2"><span class="h-1.5 w-1.5 rounded-full bg-orange-600"></span> Acronis
            backups • DR runbooks</span>
        </div>
      </div>
    </div>
  </section>
  ...
  <section id="lifecycle" class="relative bg-white py-20">
    <div class="mx-auto max-w-7xl px-6">
      <div class="max-w-3xl">
        ...
        <p class="mt-3 text-neutral-600">Simple steps. Clear owners. Measurable results. We run your SaaS like a product
          team.</p>
      </div>
      ...
      <div class="mt-12 grid gap-6 md:grid-cols-2 xl:grid-cols-4">
        <?php foreach ($steps as $s): ?>
          <article
            class="group relative rounded-2xl border border-neutral-200/70 bg-white/90 p-6 shadow-[0_6px_24px_rgba(2,6,23,0.05)] backdrop-blur">
            <div class="flex items-center justify-between">
              <span class="text-[11px] font-mono tracking-widest text-blue-700/80"><?= $s['n']; ?></span>
              <span
                class="inline-flex h-9 w-9 items-center justify-center rounded-xl bg-neutral-900 text-white ring-1 ring-white/10">→</span>
            </div>
      ...
      <div class="mt-10 rounded-xl border border-neutral-200/60 bg-white/70 p-4 backdrop-blur">
        <div class="grid gap-3 text-sm text-neutral-700 sm:grid-cols-3">
          <div class="flex items-center gap-2"><span class="h-1.5 w-1.5 rounded-full bg-blue-600"></span> 30-day
            onboarding target</div>
          <div class="flex items-center gap-2"><span class="h-1.5 w-1.5 rounded-full bg-blue-600"></span> Quarterly
            access reviews</div>
          <div class="flex items-center gap-2"><span class="h-1.5 w-1.5 rounded-full bg-blue-600"></span> Annual
            table-top DR tests</div>
        </div>
      </div>
    </div>
  </section>
  ...
  <section id="plans" class="relative isolate bg-white py-20 sm:py-24">
    <div aria-hidden="true" class="pointer-events-none absolute inset-0 -z-10">
      <div class="absolute left-1/2 top-0 -translate-x-1/2 h-[520px] w-[900px] opacity-[0.1] blur-3xl bg-brandOrbBlue">
      </div>
    ...
    <div class="mx-auto max-w-7xl px-6">
      ...
      <div class="mt-10 grid gap-6 md:grid-cols-2 xl:grid-cols-3">
        <?php foreach ($plans as $p): ?>
          <article
            class="group relative overflow-hidden rounded-2xl border border-neutral-200/60 bg-gradient-to-br <?= $p['accent']; ?> p-6 shadow-[0_6px_24px_rgba(2,6,23,0.06)] backdrop-blur">
            <div class="flex items-center justify-between">
              <h3 class="text-xl font-semibold text-neutral-900 group-hover:text-orange-600 transition-colors">
                <?= htmlspecialchars($p['name']); ?>
              </h3>
              <span
                class="inline-flex items-center rounded-full border border-neutral-200 bg-white/80 px-2.5 py-1 text-[10px] font-semibold text-neutral-700"><?= htmlspecialchars($p['tag']); ?></span>
            </div>
            <ul class="mt-4 space-y-2 text-sm text-neutral-700">
              <?php foreach ($p['includes'] as $li): ?>
                <li class="flex items-start gap-2"><span
                    class="mt-1 h-1.5 w-1.5 rounded-full bg-orange-600"></span><?= htmlspecialchars($li); ?></li>
              <?php endforeach; ?>
            </ul>
            <a href="<?= $base ?? '' ?>/contactus"
              class="mt-6 inline-flex items-center gap-2 text-sm font-medium text-orange-600 hover:text-orange-700"
              aria-label="Discuss the <?= htmlspecialchars($p['name']); ?> bundle">
              Discuss this bundle
              <svg class="h-4 w-4 transition-transform group-hover:translate-x-1" viewBox="0 0 24 24" aria-hidden="true"
                fill="currentColor">
                <path d="M13 5l7 7-7 7-1.5-1.5L16 13H4v-2h12l-4.5-4.5L13 5z" />
              </svg>
            </a>
  ...
  <section id="work" class="relative bg-white py-20 sm:py-24">
    <div class="max-w-7xl mx-auto px-6">
      <div class="text-center max-w-3xl mx-auto">
        ...
        <h2 class="mt-3 text-3xl sm:text-4xl font-semibold tracking-tight text-neutral-900">Real projects. Real
          outcomes.</h2>
      ...
      <div id="workTabsWrap" class="mt-16 relative flex flex-col items-center">
        <!-- Avatar -->
        <svg id="tabAvatar" class="absolute -top-16 h-16 w-16 transition-all duration-300 ease-out"
          viewBox="0 0 120 140" aria-hidden="true">
          <defs>
            ...
            <linearGradient id="botShell" x1="0" y1="0" x2="1" y2="1">
          ...
          <g filter="url(#softGlow)">
            <line x1="60" y1="8" x2="60" y2="18" stroke="#93c5fd" stroke-width="3" stroke-linecap="round" />
            <circle cx="60" cy="6" r="4" fill="#93c5fd" />
          </g>
          <g style="animation: botFloat 5.5s ease-in-out infinite">
            <rect x="22" y="22" rx="18" ry="18" width="76" height="60" fill="url(#botShell)" stroke="#cbd5e1"
              stroke-width="2" />
            <rect x="30" y="34" rx="12" ry="12" width="60" height="36" fill="url(#visorGrad)" />
            <g>
              <g class="eye blink">
                <circle cx="45" cy="52" r="6.5" fill="url(#accent)" />
                <circle cx="45" cy="52" r="2.2" fill="#a5f3fc" />
              </g>
              <g class="eye blink" style="animation-delay:.2s">
                <circle cx="75" cy="52" r="6.5" fill="url(#accent)" />
                <circle cx="75" cy="52" r="2.2" fill="#a5f3fc" />
              </g>
            </g>
            <circle cx="32" cy="58" r="2.6" fill="#fca5a5" opacity=".9" />
            <circle cx="88" cy="58" r="2.6" fill="#fca5a5" opacity=".9" />
            <path d="M46 68 q14 10 28 0" fill="none" stroke="#94a3b8" stroke-width="3" stroke-linecap="round" />
            <rect x="30" y="86" rx="14" ry="14" width="60" height="36" fill="url(#botShell)" stroke="#cbd5e1"
              stroke-width="2" />
            <rect x="38" y="98" width="44" height="8" rx="4" fill="#e2e8f0" />
            <rect x="38" y="98" width="22" height="8" rx="4" fill="url(#accent)" />
        ...
        <div id="workTabs" class="flex items-center justify-center gap-2" role="tablist" aria-label="Showcase tabs">
          <button data-tab="cases"
            class="tabBtn active inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-neutral-900 text-white text-[12px] font-medium"
            role="tab" aria-selected="true">Case Studies</button>
          <button data-tab="tools"
            class="tabBtn inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-slate-100 hover:bg-slate-200 text-[12px] font-medium"
            role="tab" aria-selected="false">Tools We Run</button>
        </div>
      </div>
      ...
      <div id="tab-cases">
        <div class="mt-10 grid gap-6 lg:grid-cols-[1.3fr_.9fr]">
          <a href="<?= $spotlight['url'] ?>"
            class="group relative overflow-hidden rounded-2xl ring-1 ring-slate-200 bg-white shadow-[0_20px_60px_rgba(2,6,23,.08)]">
            <div class="relative">
              <img src="<?= $spotlight['img'] ?>"
                alt="Case study — <?= htmlspecialchars($spotlight['title']) ?> results"
                class="w-full h-64 sm:h-80 lg:h-[420px] object-cover transition group-hover:scale-[1.02]">
            ...
            <div class="absolute bottom-0 left-0 right-0 p-6 sm:p-8 text-white">
              ...
              <div class="mt-4 flex flex-wrap gap-2">
                <?php foreach ($spotlight['tags'] as $t): ?><span
                    class="text-[11px] bg-white/15 backdrop-blur px-2 py-1 rounded-full ring-1 ring-white/20"><?= htmlspecialchars($t) ?></span><?php endforeach; ?>
              </div>
          ...
          <div class="grid gap-4">
            <?php foreach ($cases as $c): ?>
              <a href="<?= $c['url'] ?>"
                class="group overflow-hidden rounded-2xl ring-1 ring-slate-200 bg-white hover:shadow-md transition">
                <div class="grid grid-cols-[120px_1fr]">
                  <img src="<?= $c['img'] ?>" alt="<?= htmlspecialchars($c['title']) ?> preview"
                    class="h-full w-full object-cover">
                  <div class="p-4">
                    <h4 class="font-semibold text-neutral-900 group-hover:text-orange-600">
                      <?= htmlspecialchars($c['title']) ?>
                    </h4>
                    <p class="mt-1 text-sm text-neutral-600"><?= htmlspecialchars($c['desc']) ?></p>
                    <div class="mt-2 flex flex-wrap gap-1.5">
                      <?php foreach ($c['tags'] as $t): ?><span
                          class="text-[10px] text-blue-800 bg-blue-50 border border-blue-100 px-2 py-0.5 rounded-full"><?= htmlspecialchars($t) ?></span><?php endforeach; ?>
                    </div>
                  </div>
                </div>
              </a>
      ...
      <div id="tab-tools" class="hidden" aria-label="Tools we manage">
        <div class="mt-10 grid gap-6 sm:gap-7 md:grid-cols-2 lg:grid-cols-3">
          <?php foreach ($tools as $t): ?>
            <a href="<?= $t['url'] ?>"
              class="group relative overflow-hidden rounded-2xl border border-neutral-200/60 bg-gradient-to-br from-white to-slate-50 p-6 shadow-[0_6px_24px_rgba(2,6,23,0.06)] hover:-translate-y-1 hover:shadow-xl transition">
              <div class="flex items-center gap-3">
                <div class="h-11 w-11 rounded-xl bg-neutral-900 grid place-items-center">
                  <img src="<?= $t['logo'] ?>" alt="<?= htmlspecialchars($t['name']) ?> logo" class="h-6 w-6"
                    loading="lazy" />
                </div>
                <span
                  class="inline-flex items-center rounded-full border border-neutral-200 bg-white/80 px-2.5 py-1 text-[10px] font-semibold text-neutral-700">Tool</span>
              </div>
              ...
              <span
                class="mt-5 inline-flex items-center gap-2 text-sm font-medium text-orange-600 group-hover:text-orange-700">
                Learn more
                <svg class="h-4 w-4 transition-transform group-hover:translate-x-1" viewBox="0 0 24 24" aria-hidden="true"
                  fill="currentColor">
                  <path d="M13 5l7 7-7 7-1.5-1.5L16 13H4v-2h12l-4.5-4.5L13 5z" />
  ...
  <section id="integrations" class="relative bg-white py-20">
    <div class="max-w-7xl mx-auto px-6">
      <div class="max-w-3xl">
        <span
          class="inline-block text-[11px] font-semibold tracking-widest text-orange-600 uppercase">Integrations</span>
        <h2 class="mt-3 text-3xl md:text-4xl font-semibold">Works with your tools.</h2>
        <p class="mt-3 text-neutral-600">We connect SaaS to identity, comms, CRM, accounting, telephony, and storage—the
          wiring you actually need.</p>
      </div>
      ...
      <div class="mt-10 grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-4">
        <?php foreach ($logos as $slug):
          $name = ucfirst($slug); ?>
          <div
            class="flex items-center justify-center gap-3 rounded-xl bg-white border border-slate-200 py-3 px-4 hover:shadow-md transition">
            <?php if ($slug === 'azure'): ?>
      ...
      <div class="mt-8 text-sm text-neutral-700">Need something special? Our middleware links odd systems without duct
        tape.</div>
    </div>
  </section>
  ...
  <section id="industries" class="relative bg-slate-50 py-20">
    <div class="max-w-7xl mx-auto px-6">
      <div class="max-w-3xl">
        ...
        <p class="mt-3 text-neutral-600">Healthcare, retail, and finance have different rules. We meet them without
      ...
      <div class="mt-10 overflow-x-auto [scrollbar-width:none] [-ms-overflow-style:none]" style="scrollbar-width:none;">
        <div class="flex gap-6 min-w-max pr-6">
          ...
          <?php foreach ($cards as $c): ?>
            <div
              class="group w-[320px] flex-shrink-0 rounded-2xl bg-white border border-slate-200 p-6 hover:shadow-lg transition">
        ...
        <?php foreach ($faqs as $i => $f):
          ...
          <details class="group p-5">
            <summary class="flex cursor-pointer items-center justify-between list-none">
              ...
              <span
                class="ml-4 h-7 w-7 grid place-items-center rounded-lg bg-slate-100 text-slate-600 group-open:rotate-45 transition">+</span>
            </summary>
  ...
  <section class="relative bg-gradient-to-r from-slate-900 via-slate-800 to-slate-900 py-20">
    <div class="max-ww-5xl max-w-5xl mx-auto text-center px-6">
      ...
      <div class="mt-8 flex flex-col sm:flex-row justify-center gap-4">
        <a href="<?= $base ?? '' ?>/contactus"
          class="inline-block px-8 py-3 rounded-xl bg-orange-500 hover:bg-orange-600 text-white font-semibold shadow-lg transition">Request
          an Expert</a>
        <a href="<?= $base . '/services' ?>"
          class="inline-block px-8 py-3 rounded-xl bg-white/10 hover:bg-white/20 text-white font-semibold ring-1 ring-white/20 transition">Explore
          Services</a>
      </div>
    </div>
  ...
  <style>
    ...
    #industries [overflow-x-auto]::-webkit-scrollbar {
      display: none;
    }
  </style>
</body>
