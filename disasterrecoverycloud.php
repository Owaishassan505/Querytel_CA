        ...
        <div class="relative max-w-7xl mx-auto px-6 py-20 grid md:grid-cols-2 gap-12 items-center">
            ...
            <div class="animate-[fadeIn_0.7s_ease-out_forwards] opacity-0">
                ...
                <p class="mt-4 text-orange-50 text-lg max-w-xl">
                    Orchestrated failover for your critical workloads—spin up in minutes,
                    test without downtime, and meet recovery SLAs with confidence.
                </p>
            ...
            <div class="relative">
                ...
                <div class="relative z-10 bg-white/90 rounded-2xl shadow-2xl ring-1 ring-black/5 p-6">
                    ...
                    <svg viewBox="0 0 720 420" class="w-full h-64 md:h-80" role="img"
                        aria-label="DR failover illustration">
                        <defs>
                            <linearGradient id="drG" x1="0%" y1="0%" x2="100%" y2="100%">
                                <stop offset="0%" stop-color="#f97316" />
                                <stop offset="100%" stop-color="#1e40af" />
                            </linearGradient>
                            <linearGradient id="drSoft" x1="0%" y1="0%" x2="0%" y2="100%">
                        ...
                        <g transform="translate(80,120)">
                            <rect x="0" y="0" width="120" height="180" rx="12" fill="url(#drSoft)" stroke="#e5e7eb" />
                            <rect x="140" y="0" width="120" height="180" rx="12" fill="url(#drSoft)" stroke="#e5e7eb" />
                            <g fill="#94a3b8">
                                <rect x="24" y="28" width="72" height="12" rx="6" />
                                <rect x="24" y="64" width="72" height="12" rx="6" />
                                <rect x="24" y="100" width="72" height="12" rx="6" />
                                <rect x="164" y="28" width="72" height="12" rx="6" />
                                <rect x="164" y="64" width="72" height="12" rx="6" />
                                <rect x="164" y="100" width="72" height="12" rx="6" />
                            </g>
                        </g>

                        <!-- cloud target -->
                        <g transform="translate(480,80)">
                            <ellipse cx="60" cy="120" rx="110" ry="70" fill="#e0e7ff" />
                            <path d="M30 120a34 34 0 0160-16 42 42 0 0176 16H30z" fill="#c7d2fe" />
                            <circle cx="78" cy="100" r="10" fill="#93c5fd" />
                        </g>

                        <!-- failover arrow -->
                        <path d="M260 210h150" stroke="url(#drG)" stroke-width="10" stroke-linecap="round" />
                        <path d="M398 184l44 26-44 26z" fill="url(#drG)" />

                        <!-- labels -->
                        <g fill="#334155" font-family="ui-sans-serif,system-ui" font-size="14" font-weight="600">
                            <text x="110" y="320">Primary</text>
                            <text x="520" y="210">Cloud Recovery Site</text>
                        </g>
                    </svg>
                </div>
            </div>
