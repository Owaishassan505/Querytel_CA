        ...
        <div class="relative max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-12 items-center">
            ...
            <div class="opacity-0 animate-fadeInLeft">
                ...
                <p class="mt-4 text-lg text-slate-600 max-w-xl">
                    Stop advanced threats, segment your network, and accelerate apps with integrated SD-WAN.
                    Application awareness, AI-powered IPS, and ASIC-accelerated performance—managed from a single pane.
                </p>
                ...
                <div class="relative">
                    ...
                    <div
                        ...
                        <svg viewBox="0 0 720 430" class="w-full h-72 md:h-80" role="img"
                            aria-label="FortiGate appliance with traffic flows">
                            <defs>
                            ...
                            <!-- left cloud / users -->
                            <g opacity=".95">
                                <rect x="60" y="110" width="160" height="210" rx="12" fill="#f8fafc" stroke="#eef2f7" />
                                <circle cx="110" cy="160" r="22" fill="#dbeafe" />
                                <circle cx="170" cy="200" r="22" fill="#fee2e2" />
                                <circle cx="115" cy="235" r="18" fill="#dcfce7" />
                            </g>

                            <!-- center: FortiGate chassis -->
                            <g transform="translate(260,150)">
                                <rect x="0" y="0" width="210" height="110" rx="12" fill="#ffffff" stroke="#e5e7eb" />
                                <rect x="14" y="18" width="62" height="18" rx="4" fill="#ef4444" />
                                <rect x="90" y="18" width="100" height="18" rx="4" fill="#f8fafc" stroke="#e5e7eb" />
                                <!-- ports -->
                                <g fill="#0f172a">
                                    <rect x="16" y="54" width="18" height="10" rx="2" />
                                    <rect x="38" y="54" width="18" height="10" rx="2" />
                                    <rect x="60" y="54" width="18" height="10" rx="2" />
                                    <rect x="82" y="54" width="18" height="10" rx="2" />
                                    <rect x="104" y="54" width="18" height="10" rx="2" />
                                    <rect x="126" y="54" width="18" height="10" rx="2" />
                                    <rect x="148" y="54" width="18" height="10" rx="2" />
                                </g>
                            </g>

                            <!-- right apps / DC -->
                            <g opacity=".95">
                                <rect x="500" y="110" width="160" height="210" rx="12" fill="#f8fafc"
                                    stroke="#eef2f7" />
                                <rect x="520" y="135" width="120" height="18" rx="4" fill="#e2e8f0" />
                                <rect x="520" y="165" width="120" height="18" rx="4" fill="#e2e8f0" />
                                <rect x="520" y="195" width="120" height="18" rx="4" fill="#e2e8f0" />
                            </g>

                            <!-- flows -->
                            <path d="M220 180 C260 170 280 170 320 205" fill="none" stroke="url(#fg1)" stroke-width="6"
                                stroke-linecap="round" />
                            <path d="M220 230 C280 230 300 180 320 205" fill="none" stroke="#22c55e" stroke-width="6"
                                stroke-linecap="round" opacity=".9" />
                            <path d="M470 200 C430 210 380 210 320 205" fill="none" stroke="#3b82f6" stroke-width="6"
                                stroke-linecap="round" opacity=".9" />
                        </svg>
                    </div>
                </div>
    ...
    <section id="overview" class="bg-white py-16">
        <div class="max-w-6xl mx-auto px-6 text-center">
            ...
            <p class="mt-6 text-slate-700 leading-relaxed max-w-4xl mx-auto">
                ...
                enable the industry’s best threat protection and performance for SSL-encrypted traffic. By providing
        ...
        <div class="max-w-7xl mx-auto px-6">
            <div class="text-center">
                ...
                <p class="mt-3 text-slate-600 max-w-3xl mx-auto">
                    The Security Fabric enables organizations to achieve their digital innovations outcomes without
            ...
            <div class="mt-10 grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <article
                    ...
                    <p class="mt-4 text-sm leading-relaxed text-slate-200">Enable digital learning resources while
                        ensuring physical and digital safety of networks and students.</p>
                </article>
                ...
                <article
                    ...
                    <p class="mt-4 text-sm leading-relaxed text-slate-200">Supporting a secure smart campus with support
                ...
                <article
                    ...
                    <p class="mt-4 text-sm leading-relaxed text-slate-200">Enabling hospitality cybersecurity without
                        impacting quality of guest experience.</p>
                </article>
