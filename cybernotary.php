    ...
    <div class="max-w-3xl mx-auto px-6">
      ...
      <form class="space-y-6">
        <div class="grid md:grid-cols-2 gap-6">
          <input type="text" placeholder="Your Name" class="w-full border border-neutral-900 px-4 py-3 rounded-[2px]"
            required />
          <input type="email" placeholder="Email Address"
            class="w-full border border-neutral-900 px-4 py-3 rounded-[2px]" required />
        </div>
        <input type="tel" placeholder="Phone Number" class="w-full border border-neutral-900 px-4 py-3 rounded-[2px]"
          required />
