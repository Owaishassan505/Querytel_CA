...
<head>
  ...
  <title>QueryTel Inc. — Managed IT, Cybersecurity & Cloud Services in North America</title>
  ...
  <meta property="og:title" content="QueryTel Inc. — Managed IT, Cybersecurity & Cloud Services in North America" />
  ...
  <meta name="twitter:title" content="QueryTel Inc. — Managed IT, Cybersecurity & Cloud Services in North America" />
...
<body class="bg-white text-neutral-900 font-sans">
  ...
  <section id="heroSlider" class="relative overflow-hidden">
    <div class="glide">
          ...
          <li class="glide__slide">
            <div
              ...
              <div>
                ...
                <h1 class="text-4xl md:text-5xl font-semibold tracking-tight text-neutral-900 leading-tight">
                  Power Your Business<br />with BrokerBand.
                </h1>

                <p class="mt-6 text-lg text-gray-600">
                  Brokerband brings you the latest tech products, networking gear, and IT solutions. Sourced from
                  trusted distributors and delivered with speed. Shop smarter, scale faster, and stay connected.
                </p>
              ...
              <div>
                <img src="<?= $base . '/assets/images/brokerband-banner.png' ?>" alt="Brokerband Online Store"
                  class="w-full rounded-lg shadow-md" />
              </div>
            </div>
          </li>
      ...
      <div class="absolute bottom-6 left-1/2 -translate-x-1/2 flex items-center gap-4 z-20" data-glide-el="controls">
        <button class="glide__arrow glide__arrow--left text-xl text-gray-400 hover:text-gray-600 transition"
          data-glide-dir="<">‹</button>
        <div class="glide__bullets flex gap-2" data-glide-el="controls[nav]">
          <button class="glide__bullet w-3 h-3 rounded-full bg-gray-400 opacity-70 hover:opacity-100"
          ...
          <button class="glide__bullet w-3 h-3 rounded-full bg-gray-400 opacity-70 hover:opacity-100"
            data-glide-dir="=4"></button> <!-- New dot for slide 5 -->
        </div>
        <button class="glide__arrow glide__arrow--right text-xl text-gray-400 hover:text-gray-600 transition"
          data-glide-dir=">">›</button>
      </div>
    ...
    <div class="max-w-7xl mx-auto px-6">
      ...
      <div class="grid md:grid-cols-3 gap-10">
        ...
        foreach ($services as $i => $s): ?>
          <div
            class="service-card bg-white p-10 rounded-lg shadow hover:shadow-xl transition duration-300 text-center transform hover:-translate-y-2 opacity-0 translate-y-6"
  ...
  <section class="py-24 bg-white relative">
    <div class="max-w-7xl mx-auto px-6">
      ...
      <!-- Clients Table Grid -->
      <div class="overflow-hidden rounded-xl shadow-sm border border-neutral-200 animate-fade-up"
      ...
      <!-- Experience -->
      <div class="mt-20 bg-gray-50 rounded-xl p-10 md:flex md:items-center md:justify-between shadow-sm animate-fade-up"
