        ...
        <div class="relative max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-12 items-center">
            ...
            <div class="opacity-0 animate-fadeInLeft">
                ...
                <p class="mt-4 text-lg text-slate-600 max-w-xl">
                    Centralize logs, visualize threats, and automate responses across your Fortinet fabric.
        ...
        <div class="max-w-6xl mx-auto px-6 text-center">
            ...
            <p class="mt-6 text-slate-700 leading-relaxed max-w-4xl mx-auto">
                FortiAnalyzer is a <span class="font-semibold">powerful log management, analytics, and reporting
                    platform</span>,
                providing organizations with single-pane orchestration, automation, and response for simplified security
                operations,
                proactive identification and remediation of risks, and complete visibility of the entire attack surface.
            </p>
        </div>
    </section>
            ...
            <div class="mt-10 grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <article
                    ...
                    <p class="mt-4 text-sm leading-relaxed text-slate-200">
                        Reduce time to detection using Indicators of Compromise (IoCs) and correlation to quickly
                        identify threats across the network.
                    </p>
                </article>
                ...
                <article
                    ...
                    <p class="mt-4 text-sm leading-relaxed text-slate-200">
                        Automatically backs up the FortiAnalyzer database to clusters (up to 4 nodes) for DR; any
                        secondary node can become primary.
                    </p>
                </article>
        ...
        <div class="relative max-w-7xl mx-auto px-6">
            ...
            <div class="mt-10 grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <a href="#"
                    ...
                    <p class="px-5 pt-4 pb-6 text-sm text-slate-300">
                        Comprehensive IPS with breadth and depth of coverage for both known and zero-day attacks.
                    </p>
                </a>
